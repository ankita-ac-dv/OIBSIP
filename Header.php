...
<body>
    <header class="text-black-900 body-font bg-blue-800">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row bg-white items-center fixed shadow-lg">
            ...
            <!-- <button class="inline-flex items-center text-white mx-2 bg-blue-600 border-0 py-1 px-3 focus:outline-none hover:bg-blue-600 rounded text-base mt-4 md:mt-0">Sign Up
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
            </button> -->
